...
import time
import grpc
import pump_databroker_pb2_grpc
import pump_databroker_pb2

port = 8061


class PumpSensorDatabroker(pump_databroker_pb2_grpc.PumpSensorDatabrokerServicer):
    def __init__(self):
    ...
    def get_next(self, request, context):
        response = pump_databroker_pb2.Measurement()
...
pump_databroker_pb2_grpc.add_PumpSensorDatabrokerServicer_to_server(PumpSensorDatabroker(), server)
